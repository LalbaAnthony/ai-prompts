...
Avec un fichier `docker-compose.yml` pour orchestrer les services à la racine du projet.
...
Les deux `Dockerfile.*` doivent être utilisés dans le `docker-compose.yml` avec différents profiles et services.
